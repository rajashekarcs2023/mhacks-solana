...
export async function analyzePortfolio(connection, address) {
    try {
...
function calculateRiskMetrics(holdings, totalValue) {
...
function generateRecommendations(riskMetrics, holdings) {
...
function generateWarnings(riskMetrics, holdings) {
    const warnings = [];
    if (riskMetrics.rugPullRisk === 'HIGH') {
...
function generateAIInsights(holdings, riskMetrics, healthScore) {
...
//# sourceMappingURL=portfolio-doctor.js.map